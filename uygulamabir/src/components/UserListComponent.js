  ...
  render() {
    return (
      <div className='container mt-5'>
        ...
        {this. state.visible ? (<FormComponent  visible={this.state.visible} hide={this.hide} addUser={this.props.addUser} editUser={this.props.editUser}
        user={this.state.user} title= {this.state.title} />): null
      }
